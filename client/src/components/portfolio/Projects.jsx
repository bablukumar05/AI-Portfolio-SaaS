...
export default function Projects({ data = {} }) {
  const {
    ...
    title = "Featured <br/> <span class='text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary'>Deployments.</span>"
  } = data;
  ...
  return (
    <section id="projects" className="py-32 px-6 relative z-10 bg-[#f8fafc] dark:bg-dark-900 transition-colors duration-300">
          ...
          <div className="max-w-2xl">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="flex items-center gap-2 text-primary font-bold uppercase tracking-widest text-sm mb-4">
                <FolderGit2 size={18} /> {subtitle}
              </h2>
              <h3
                className="text-4xl md:text-6xl font-heading font-black text-slate-900 dark:text-white leading-tight"
